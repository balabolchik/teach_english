...
function askInEnglish() {
  while (english.length > 0) {
    ...
    answerIsCorrect = confirm(english.length + ' || ' + ukraine.length + "\n" + english[randomNumber] + "\n" + ukraine[randomNumber]);
    if (answerIsCorrect) {
